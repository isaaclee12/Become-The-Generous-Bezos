...
function App() {
  ...
  const [oldWealth, setOldWealth] = useState(202000000000);
      ...
      <section className="flex-row-center top-bar">
        <div className="sticky stretch">
          ...
          <div className="wealth-counter text-center">
            $<CountUp start={oldWealth} end={wealth} duration={1} separator=","></CountUp>
            {/* <h3 className="">{"$" + oldWealth.toLocaleString("en-US")}</h3> */}
